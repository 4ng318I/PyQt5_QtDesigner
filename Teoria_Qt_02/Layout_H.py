...
class Window(QWidget):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("Python GUI QHBoxLayout")
        ...
        # creamos el objeto lyout horizontal
        hlayout = QHBoxLayout()
        ...
        #agregamos separacion con el siguiente boton
        hlayout.addSpacing(25)
        hlayout.addWidget(btn3)
        hlayout.addWidget(btn4)
        # agregar strech estirar a la izquierda horizontalmente
        hlayout.addStretch(5)


        # Mostramos el layout con lo que hay en su interior
